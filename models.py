...
class HKRunner(ModelBase):
    ...
    Sec3Time = Column('Sec3Time', Time, nullable=False)
    Sec4Time = Column('Sec4Time', Time, nullable=False)
    Sec5Time = Column('Sec5Time', Time, nullable=False)
    Sec6Time = Column('Sec6Time', Time, nullable=False)
